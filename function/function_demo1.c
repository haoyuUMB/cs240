//
// Created by AV Services on 9/22/2022.
//
# include <stdio.h >

//  you can access/write data across function stack which is dangerous
//  do some experiment

void print_p(void *p) { printf("%p\n", p); }

void print_lu(long unsigned n) { printf("%lu\n", n); }
